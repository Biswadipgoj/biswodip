...
export default function Stack() {
  ...
  return <section id="stack" ref={ref} className="stack-section section-space">
    ...
    <div className="request-pipeline glass-panel" data-reveal="3d-flip" data-tilt-3d data-scroll-3d style={{margin: '48px 0', padding: '32px', borderRadius: '16px'}}>
    ...
    <div className="stack-categories" data-stagger>
      {stack.map(category => <div className="stack-category glass-panel" key={category.title} data-reveal="3d-depth" data-tilt-3d data-scroll-3d style={{padding: '28px', borderRadius: '14px'}}>
    ...
    <dl className="stack-notes" data-stagger>
      {stackCopy.notes.map(note => <div key={note.name} className="glass-panel" data-reveal="3d-flip" data-tilt-3d data-scroll-3d style={{padding: '22px', borderRadius: '12px'}}>
        <dt>{note.name}</dt>
        <dd>{note.body}</dd>
      </div>)}
    </dl>
